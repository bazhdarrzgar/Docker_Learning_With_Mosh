...
* there s a problem here if you connect with this docker as normal user not like root user you can't do anything in that folder because the permission this folder will be this ( drwxr-xr-x ) means the user it can't write in that folder to fix that you can create folder when you build the project
